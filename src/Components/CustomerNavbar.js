        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-8">
            <Link to="/" className="flex items-center gap-2 text-[#0d1b10] group">
              ...
              <h2 className="text-xl font-bold leading-tight tracking-tight group-hover:text-primary transition-colors">Tea Soul</h2>
            </Link>
            <nav className="hidden md:flex items-center gap-8">
              ...
              <Link to="/" className="text-sm font-medium hover:text-primary transition-colors">Subscriptions</Link>
            </nav>
          </div>
