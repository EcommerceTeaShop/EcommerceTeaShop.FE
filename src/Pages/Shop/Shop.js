...
const Shop = () => {
  ...
  const baseProducts = [
    {
      id: 1, name: 'Imperial Matcha', type: 'Green Tea', origin: 'Uji, Japan', rating: '4.9', price: '$28.00', size: '30g Tin', desc: 'Vibrant green ceremonial grade powder with distinct umami notes.', badge: 'Best Seller', badgeColor: 'bg-primary text-[#0d1b10]', img: 'https://lh3.googleusercontent.com/aida-public/AB6AXuAacKjJEwsR2ONaRZe8c_yYC9f2EaBCNBdkoeD3rk5u_YLjwLTTHq3caX4VBTeFhwaZhCXMwfx1uede07YocpZfbz3zSm4dDTeMArH9il756PAY_KRPdxzaH7dSLsSkDuSCWtylICi5fyAIpFKVpfHoYqtkzrNVIw_LC_8kxSc_G2hCDK6BjEVeFI1QeS40XT_nN2m1HECvuM5iS1ISCqku9IWzMdPOmlERjwo-TyhEFiRMMCsyrVn_rvuE28vZW2_9hVi6b426Ln22'
    },
    {
      id: 2, name: 'Sencha Reserve', type: 'Green Tea', origin: 'Shizuoka, Japan', rating: '4.7', price: '$16.50', size: '100g Bag', desc: 'Deep steamed green tea with a rich, grassy aroma and sweet finish.', img: 'https://lh3.googleusercontent.com/aida-public/AB6AXuBLUAXmxJa8DR4Q4uI5HFGdZtwiPKB7eoAoCnBvpW-BQoM1Zo9gg1tYHsDXr4sop91GdPYo1i2PgmFpu2MFkfigzm4Y-_Esgcs5I26KBFWQ7t4gpx4z9emSFR_4mnQjeYJlzK2BcJnlxCyLdWq5r41U6Z9jXvU-IV9d05fjKmc964yzzE4Ej4LLPxviPV0sAm_WElsB9OnJttyMUq93CJXuA0vPn41iIDrrG7pq8D5T-8MznrvcY1lAcKo3Z2TNgWl0pn6Qs-i5Q7af'
    },
    {
      id: 3, name: 'Jasmine Pearls', type: 'Green Tea', origin: 'Fujian, China', rating: '4.8', price: '$22.00', oldPrice: '$28.00', size: '50g Tin', desc: 'Hand-rolled tea pearls infused with fresh jasmine blossoms.', badge: 'Sale', badgeColor: 'bg-red-500 text-white', img: 'https://lh3.googleusercontent.com/aida-public/AB6AXuBa3a1VM20Me0D-3SLjzYpzZuu8aEkA4-vCSPOPpQo3In4iq_18dE872EXoIp1MWh5eXsQ6o4jYb-C4wbgYlG1v4Vdi01oZBANGqrtuipcK2HRgI8z4zPAvf4iVdk86RDe2HgjQSaaiZAoMjuOF_apnjHd94kDl7kO8Kscg9TmSwOMDn0ZbM_gsNB7C3QMuxRu7EbU0QRVfjKoBdzaz5T6zOAd67ZtQzxVc2elQMmcRmJAx_BFaIS76wHrBEI1Nb6MUCyDSCuAdB7ep'
    },
    {
      id: 4, name: 'Milk Oolong', type: 'Oolong', origin: 'Taiwan', rating: '5.0', price: '$32.00', size: '75g Bag', desc: 'Naturally creamy and smooth with a distinct floral aroma.', img: 'https://lh3.googleusercontent.com/aida-public/AB6AXuDeJTOy1I4Hrk7_GpxYikfBfw1GNqzV1vdbvGwtAVUTCu_BRorMewJc_U7jORsfmWUJd7FR5ZWPR5kAR3RMd_u5Ef7-nwhvuUE7Gcivry2wqpKXFLOKSl6B0Z5HtW0_NjsjYMLk2lNi2M7TfvE4w3MF84YXMcE9iKFJk07V7YeF60iIEEc3EoFeEACDdFGDqOqHwTBV0IbWKIb0nNo7W13prt5sNl7iasXLmnIMTYAKLcrtR6ZYrjcka9KhzhYgUbrFG-kZjkiPv0O1'
    },
    {
      id: 5, name: 'Earl Grey Superior', type: 'Black Tea', origin: 'Assam, India', rating: '4.6', price: '$14.00', size: '100g Bag', desc: 'A bold black tea blend featuring premium bergamot oil.', img: 'https://lh3.googleusercontent.com/aida-public/AB6AXuCGsQ67LpE7LXnpncD0HODoayKRWX6J_SFC8NxrHG6LFL5b3qzAwmaSds7iSTxnayAEJDivWLzxZzdQC1WZDb1HfDA4cCpG83ZR5eWWluPFWBdTs0_if-ChNFtdz1UU3jqwPonq_G-0DMlZmLxYEGjfzKqpvDWE_04IBqkw_MrpdvutW5A_v2WbgC7JQMod4YkObI64yM8qBm-yD9Q9txm4JpYShY_D4CHFzwmNv4hnWTyIHabp-iNPqeSg2efq5OOhxN-3ObE_wp3B'
    },
    {
      id: 6, name: 'Kyoto Genmaicha', type: 'Green Tea', origin: 'Kyoto, Japan', rating: '4.9', price: '$18.00', size: '100g Bag', desc: 'Green tea combined with roasted popped brown rice.', badge: 'Limited', badgeColor: 'bg-gray-900/80 text-white backdrop-blur-sm', img: 'https://lh3.googleusercontent.com/aida-public/AB6AXuB3OGReXx6tkaV-I_QekT7XrthlnELOXvauVdZwPjMQPmW6uUzVCcaz3f7l_aTa77DyauV38857t9ErJbPObX1BV47Q0EhbvFHHO4-a-LuQDkTGqEYq77CrSKRhuv-uVDjU0x-QnAkJ48a90TJG6DML_zdSRYByHq4BSZQpbX2pmD9MWVPyrlI-EuEmOeffSYuzlwU5zHmEoevWrVGLzDnYjqLA5hRuudv2CwSpqKhpjv-uvoaxTcGomd2AYOCdUP1UOWqQ5KR5wS_w'
    }
  ];
  ...
  const products = [
    ...baseProducts,
    ...baseProducts.map(p => ({ ...p, id: p.id + 6, name: `${p.name} (Batch 2)` }))
  ];
  ...
  let processedProducts = products.filter(item => {
    ...
    const matchOrigin = selectedOrigins.length === 0 || selectedOrigins.includes(originMap[item.origin]);
  ...
  if (sortBy === 'Price: Low to High') {
    processedProducts.sort((a, b) => parseFloat(a.price.replace('$', '')) - parseFloat(b.price.replace('$', '')));
  } else if (sortBy === 'Price: High to Low') {
    processedProducts.sort((a, b) => parseFloat(b.price.replace('$', '')) - parseFloat(a.price.replace('$', '')));
  }

  // 3. Paginate
  const totalPages = Math.ceil(processedProducts.length / ITEMS_PER_PAGE);
  const displayedProducts = processedProducts.slice((currentPage - 1) * ITEMS_PER_PAGE, currentPage * ITEMS_PER_PAGE);
      ...
      <div className="w-full max-w-[1440px] px-4 md:px-10 flex flex-col lg:flex-row gap-8 items-start mt-8">
        ...
        <aside className="w-full lg:w-64 shrink-0 lg:sticky lg:top-24 bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
          <div className="flex items-center justify-between mb-6">
            ...
            <button onClick={handleReset} className="text-xs text-gray-500 hover:text-primary font-bold">Reset</button>
          </div>
          ...
          <div className="mb-6 border-t border-gray-100 pt-6">
            ...
            <div className="space-y-3">
              {['Japan (Uji)', 'China (Fujian)', 'India (Assam)'].map((origin) => (
          ...
          <div className="border-t border-gray-100 pt-6">
            ...
            <input 
              ...
              style={{ background: `linear-gradient(to right, #22c55e ${priceRange}%, #e5e7eb ${priceRange}%)` }}
            />
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
            <div className="flex flex-wrap gap-2 items-center">
              {activeFilters.map(filter => (
                <div key={filter} className="flex h-8 items-center justify-center gap-x-2 rounded-full border border-primary/30 bg-primary/10 pl-3 pr-2">
                  <p className="text-[#0d1b10] text-xs font-bold">{filter}</p>
                  <button 
                    onClick={() => {
                      if (selectedTypes.includes(filter)) toggleFilter(filter, selectedTypes, setSelectedTypes);
                      if (selectedOrigins.includes(filter)) toggleFilter(filter, selectedOrigins, setSelectedOrigins);
                    }} 
              ...
              {activeFilters.length > 0 && (
                <button onClick={handleReset} className="text-xs font-bold underline text-gray-500 hover:text-primary ml-1">
                  Clear all
                </button>
              )}
            </div>
            ...
            <div className="mt-12 flex justify-center">
              <nav className="flex items-center gap-2">
                <button 
                  ...
                  className="h-10 w-10 flex items-center justify-center rounded-lg hover:bg-surface-light text-gray-500 transition-colors disabled:opacity-50"
                >
                  ...
                  <button 
                    ...
                    className={`h-10 w-10 flex items-center justify-center rounded-lg font-bold transition-colors ${
                      currentPage === num 
                        ...
                        : 'hover:bg-surface-light text-gray-500'
                    }`}
                  >
                    {num}
                  </button>
